...
namespace Proje_Hastane
{
    public partial class FrmSekreterDetay : Form
    {
        ...
        private void BtnDoktorPanelı_Click(object sender, EventArgs e)
        {
            FrmDoktorPanelı fr = new FrmDoktorPanelı();
            fr.Show();
        }

        private void BtnBransPanelı_Click(object sender, EventArgs e)
        {
        ...
        {
            FrmRandevuLıstesı fr = new FrmRandevuLıstesı();
            fr.Show();
        }
