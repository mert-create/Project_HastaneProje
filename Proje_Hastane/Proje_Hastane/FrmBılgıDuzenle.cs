...
namespace Proje_Hastane
{
    public partial class FrmBılgıDuzenle : Form
    {
        ...
        {
           SqlCommand komut2 = new SqlCommand("Update Tbl_Hastalar set HastaAd=@p1,HastaSoyad=@p2,HastaTelefon=@p3,HastaSıfre=@p4,HastaCınsıyet=@p5 where HastaTC=@p6", bgl.baglanti());
